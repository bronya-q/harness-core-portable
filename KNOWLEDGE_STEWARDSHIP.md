...
```json
{
  ...
  "private": true,
  "portable": false,
  "working_directory": "[PRIVATE_LOCAL_KB]",
  "launcher": { "kind": "python_script", "path": "[PRIVATE_LOCAL_KB]/blanche_persona.py" },
  "knowledge_sources": [ { "path": "[PRIVATE_LOCAL_KB]", "domain": "feminism", "mode": "read_only" } ],
