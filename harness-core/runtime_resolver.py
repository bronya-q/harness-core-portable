...
ROOT = Path(r'[LOCAL_WORKSPACE]\whale-sister')
...
_FALLBACK = {
    ...
    'blanche': {'persona_id': 'blanche', 'model': None, 'scope': 'character:blanche', 'source': Path(r'~\[PRIVATE_LOCAL_KB]\14_人格布兰奇.md'), 'entrypoint': Path(r'[DESKTOP]\blanche_terminal.bat')},
