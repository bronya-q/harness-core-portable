...
> ⚠️ **发布后发现（已修复）**：发布时 GitHub Actions 在 Ubuntu 3.13 存在失败；后续重写 MCP stdio 测试后，`bc0bfb2` / `cf52ee5` 的 CI 已转绿（4 个 matrix job 全部通过）。详见 `docs/deployments/2026-09-05-github-release-v0.1.0-alpha.4-external-verification.md`。
